...
private:
    ...
    • Required for locations which are stops (location_type=0), stations (location_type=1) or entrances/exits (location_type=2).
    • Optional for locations which are generic nodes (location_type=3) or boarding areas (location_type=4).*/
    /* Latitude */ double stop_lat; // Conditionally Required
    ...
    • Required for locations which are stops (location_type=0), stations (location_type=1) or entrances/exits (location_type=2).
    • Optional for locations which are generic nodes (location_type=3) or boarding areas (location_type=4).*/
    /* Longitude */ double stop_lon; // Conditionally Required
    ...
    int zone_id; // Conditionally Required
    ...
    location_type_enum location_type; // Optional
    ...
    /* ID referencing levels.level_id */ int level_id; // Optional
    ...
    std::string platform_code; // Optional
};
